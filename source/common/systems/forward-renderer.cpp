...
namespace our
{
    ...
    void ForwardRenderer::render(World *world)
    {
        ...
        glm::mat4 VP = camera->getProjectionMatrix(windowSize) * View_matrix;
        ...
        if (this->skyMaterial)
        {
            ...
            SkyModel[0][3] = cameraPosition.x;
            SkyModel[1][3] = cameraPosition.y;
            SkyModel[2][3] = cameraPosition.z;
            ...
            skyMaterial->shader->set("transform", alwaysBehindTransform * projection * SkyModel);
